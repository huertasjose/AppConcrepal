...
export '/pages/completar_perfil/completar_perfil_widget.dart'
    show CompletarPerfilWidget;
export '/pages/perfil/perfil_widget.dart' show PerfilWidget;
export '/pages/catalogo_productos/catalogo_productos_widget.dart'
    show CatalogoProductosWidget;
export '/pages/gestion_ventas/gestion_ventas_widget.dart'
    show GestionVentasWidget;
export '/pages/gestion_clientes/gestion_clientes_widget.dart'
    show GestionClientesWidget;
export '/pages/metricas/metricas_widget.dart' show MetricasWidget;
