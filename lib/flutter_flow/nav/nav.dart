...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.loggedIn
          ? NavBarPage()
          : IniciarSesionRegistrarseWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ChatBot')
              : ChatBotWidget(),
        ),
        FFRoute(
          name: OlvidarContrasenaWidget.routeName,
          path: OlvidarContrasenaWidget.routePath,
          builder: (context, params) => OlvidarContrasenaWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CatalogoProductosWidget.routeName,
          path: CatalogoProductosWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CatalogoProductos')
              : CatalogoProductosWidget(),
        ),
        FFRoute(
          name: GestionVentasWidget.routeName,
          path: GestionVentasWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'GestionVentas')
              : GestionVentasWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'GestionClientes')
              : GestionClientesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: IniciarSesionRegistrarseWidget.routeName,
          path: IniciarSesionRegistrarseWidget.routePath,
          builder: (context, params) => IniciarSesionRegistrarseWidget(),
        )
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        redirect: (context, state) {
          ...
          if (requireAuth && !appStateNotifier.loggedIn) {
            ...
            return '/iniciarSesionRegistrarse';
          }
          return null;
        },
