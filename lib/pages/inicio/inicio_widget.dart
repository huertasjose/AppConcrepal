                ...
                Column(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed(CatalogoProductosWidget.routeName);
                      },
                      child: Container(
                ...
                Column(
                  ...
                  children: [
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed(GestionVentasWidget.routeName);
                      },
                      child: Container(
                        width: MediaQuery.sizeOf(context).width * 0.4,
                        height: MediaQuery.sizeOf(context).width >= 768.0
                  ...
                  Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(GestionClientesWidget.routeName);
                        },
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 0.4,
                          height: MediaQuery.sizeOf(context).width >= 768.0
